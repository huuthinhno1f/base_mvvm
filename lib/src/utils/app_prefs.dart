...
class AppPrefs {
  ...
  static final BehaviorSubject<int> _numberEvent = BehaviorSubject<int>();
  ...
  static initListener() async {
    ...
    _box.listenKey('countEvent', (data) {
      _numberEvent.add(data);
    });
    _box.listenKey('history_search', (history) {
  ...
  static set countEvent(int? data) => _box.write('countEvent', data);

  static int? get countEvent => _box.read('countEvent');

  static set firstTime(bool? onBoarding) => _box.write('firstTime', onBoarding);

  static bool get firstTime => _box.read('firstTime') ?? true;

  static set historySearch(List<String>? history) => _box.write('history_search', history);
  ...
  static Stream<int> get watchNumberEvent => _numberEvent.stream;
